...
france({ nomCom: "owner", categorie: "General", reaction: "🔰" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "|Exton|", numero: "263781206152" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "🔰 Exton-MD OWNER 🔰:\n\n";
...
france({ nomCom: "help", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  repondre("_APKO HELP CHAHYE MERA Exton-MD KA OFFICIAL WHATSAPP CHANNEL FOLLOW KARO_")
  await zk.sendMessage(auteurMessage,{text : `https://whatsapp.com/channel/0029VaVCDGH0G0XbD73uZ42W`},{quoted :ms})
